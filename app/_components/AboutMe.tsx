    ...
    return (
        <section className="pb-section" id="about-me">
            <div className="container" ref={container}>
                <h2 className="text-6xl md:text-8xl font-thin mb-20 slide-up-and-fade">
                ...
                <div className="grid md:grid-cols-12 mt-9">
                    <div className="md:col-span-5">
                        <p className="text-6xl slide-up-and-fade">
                            Hi, I&apos;m Hari Om Verma.
                        </p>
                    </div>
                    <div className="md:col-span-7">
                        <div className="text-xl text-muted-foreground max-w-[450px]">
