        ...
        <>
            ...
            >
                ...
                <div className="w-full max-w-[300px] mx-8 sm:mx-auto">
                    ...
                    >
                        <span className="h-10 px-5 border border-primary text-primary font-anton tracking-widest text-sm uppercase flex items-center gap-2 group-hover:bg-primary group-hover:text-primary-foreground transition-all duration-300">
                            <svg
